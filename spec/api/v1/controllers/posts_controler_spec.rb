...
RSpec.describe Api::V1::PostsController, type: :controller do
  ...
  context "unauthenticated user" do
    it "PUT update returns http unauthenticated" do
      put :update, topic_id: my_topic.id, id: my_post.id, post: {title: "Post Name", body: "Updated post body 20 characters"}
  ...
  context "authenticated and authorized users" do
    ...
    describe "PUT update" do
      before { put :update, topic_id: my_topic.id, id: my_post.id, post: {title: "Post Name", body: "Updated post body 20 characters"} }
